...
- [x] `float_random` - implemented (+63 tests now passing)

### Float Ops (17 missing)
- [ ] `float_into_int`, `float_cast`
...
### Int Ops (16 missing)
- [ ] `int_add`, `int_sub`, `int_mul`, `int_div` (and scalar variants)
- [ ] `int_remainder`, `int_into_float`, `int_permute`
- [ ] `int_mask_where`, `int_mask_fill`
- [ ] `int_gather`, `int_scatter_add`, `int_select`, `int_select_add`

### Bool Ops (10 missing)
- [ ] `bool_into_int`, `bool_into_float`
