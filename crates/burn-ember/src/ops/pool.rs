...
macro_rules! max_pool3d_backward_typed {
    ($fn_name:ident, $T:ty, $dtype:expr, $zero:expr, $add_fn:expr) => {
        pub fn $fn_name(x: EmberTensor, grad: EmberTensor, indices: EmberTensor) -> EmberTensor {
    ...
    T: bytemuck::Pod + Copy + PartialOrd + Send + Sync + Element,
{
    ...
    let output_tensor = EmberTensor::new(
        Bytes::from_elems(output),
        Layout::contiguous(out_shape.clone()),
        dtype,
    );
    let indices_tensor = EmberTensor::new(
...
pub fn adaptive_avg_pool2d_f32(x: EmberTensor, output_size: [usize; 2]) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
...
pub fn adaptive_avg_pool2d_f64(x: EmberTensor, output_size: [usize; 2]) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
...
pub fn adaptive_avg_pool2d_f16(x: EmberTensor, output_size: [usize; 2]) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
...
pub fn adaptive_avg_pool2d_bf16(x: EmberTensor, output_size: [usize; 2]) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
...
pub fn adaptive_avg_pool1d_f32(x: EmberTensor, output_size: usize) -> EmberTensor {
    let x_3d = expand_1d_to_3d(&x);
...
pub fn max_pool2d_backward_f16(
    x: EmberTensor,
    grad: EmberTensor,
    indices: EmberTensor,
) -> EmberTensor {
...
pub fn adaptive_avg_pool2d_backward_f32(x: EmberTensor, grad: EmberTensor) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
    let grad_3d = expand_2d_to_3d(&grad);
...
pub fn adaptive_avg_pool2d_backward_f64(x: EmberTensor, grad: EmberTensor) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
    let grad_3d = expand_2d_to_3d(&grad);
...
pub fn adaptive_avg_pool2d_backward_f16(x: EmberTensor, grad: EmberTensor) -> EmberTensor {
    let x_3d = expand_2d_to_3d(&x);
    let grad_3d = expand_2d_to_3d(&grad);
...
pub fn adaptive_avg_pool2d_backward_bf16(x: EmberTensor, grad: EmberTensor) -> EmberTensor {
    let x_f32 = convert_bf16_to_f32(&x);
    let grad_f32 = convert_bf16_to_f32(&grad);
...
fn expand_2d_to_3d(x: &EmberTensor) -> EmberTensor {
...
fn squeeze_3d_to_2d(x: EmberTensor) -> EmberTensor {
    let shape = x.layout().shape();
    x.reshape(Shape::from(vec![
        shape.dims[0],
        shape.dims[1],
...
fn expand_1d_to_3d(x: &EmberTensor) -> EmberTensor {
    let shape = x.layout().shape();
    x.reshape(Shape::from(vec![
        shape.dims[0],
        shape.dims[1],
...
fn squeeze_3d_to_1d(x: EmberTensor) -> EmberTensor {
    let shape = x.layout().shape();
    x.reshape(Shape::from(vec![
        shape.dims[0],
        shape.dims[1],
...
mod tests {
    ...
    fn test_max_pool2d_with_dilation() {
        ...
        let x = EmberTensor::from_data(TensorData::new(x_data, vec![1, 1, 5, 5]));
    ...
    fn test_pool1d_delegation() {
        ...
        let x = EmberTensor::from_data(TensorData::new(x_data, vec![1, 1, 8]));
    ...
    fn test_max_pool3d_basic() {
        ...
        let x = EmberTensor::from_data(TensorData::new(x_data, vec![1, 2, 4, 4, 4]));
    ...
    fn test_max_pool_backward() {
        // Forward pass
        let x_data: Vec<f32> = (1..=16).map(|x| x as f32).collect();
        let x = EmberTensor::from_data(TensorData::new(x_data.clone(), vec![1, 1, 4, 4]));
        let (_output, indices) =
            max_pool2d_with_indices_f32(x.clone(), [2, 2], [2, 2], [0, 0], [1, 1], false);

        // Backward pass: gradient of 1.0 for each output
        let grad = EmberTensor::from_data(TensorData::new(vec![1.0f32; 4], vec![1, 1, 2, 2]));
    ...
    fn test_avg_pool_backward() {
        ...
        let grad = EmberTensor::from_data(TensorData::new(vec![4.0f32; 4], vec![1, 1, 2, 2]));
