...
fn convert_bf16_to_f32(x: &EmberTensor) -> EmberTensor {
...
fn convert_f32_to_bf16(x: &EmberTensor) -> EmberTensor {
    let x = x.clone().to_contiguous();
...
mod tests {
    ...
    fn make_input_f32(batch: usize, channels: usize, height: usize, width: usize) -> EmberTensor {
