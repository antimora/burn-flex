...
fn main() {
    println!("Integer Operations Benchmarks: Ember vs NdArray");
...
bench_cast_backend!(Ember, ember_cast, "Ember_Cast");
...
bench_random_backend!(Ember, ember_random, "Ember_Random");
