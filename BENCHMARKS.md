...
| Size | Ember  | NdArray | Speedup  | Ember Mem | NdArray Mem |
| ---- | ------ | ------- | -------- | --------- | ----------- |
| 1K   | 176 ns | 380 ns  | **2.2x** | 85 B      | 558 B       |
| 64K  | 6.3 us | 14.6 us | **2.3x** | 100 B     | 524 KB      |
| 1M   | 52 us  | 222 us  | **4.3x** | 100 B     | 8.4 MB      |

### Sum Along Dimension

| Shape     | Dim | Ember   | NdArray | Speedup  |
| --------- | --- | ------- | ------- | -------- |
| 256x256   | 0   | 5.4 us  | 20.6 us | **3.8x** |
| 256x256   | 1   | 4.4 us  | 12.8 us | **2.9x** |
| 1024x1024 | 0   | 79.6 us | 221 us  | **2.8x** |
| 1024x1024 | 1   | 79.7 us | 207 us  | **2.6x** |

### 3D Sum (Batched)

| Shape      | Dim | Ember  | NdArray | Speedup  |
| ---------- | --- | ------ | ------- | -------- |
| 32x256x256 | 1   | 152 us | 543 us  | **3.6x** |
| 32x256x256 | 2   | 131 us | 374 us  | **2.9x** |

### Sum Transposed

| Size      | Ember   | NdArray | Speedup  |
| --------- | ------- | ------- | -------- |
| 256x256   | 6.2 us  | 6.1 us  | 1.0x     |
| 1024x1024 | 54.7 us | 96.6 us | **1.8x** |

### Sum Dim on Transposed

| Size      | Dim | Ember   | NdArray | Speedup  |
| --------- | --- | ------- | ------- | -------- |
| 256x256   | 0   | 3.9 us  | 4.4 us  | **1.1x** |
| 1024x1024 | 0   | 80.5 us | 80.3 us | 1.0x     |

### Mean Along Dimension

| Shape     | Dim | Ember   | NdArray | Speedup  |
| --------- | --- | ------- | ------- | -------- |
| 256x256   | 1   | 4.2 us  | 13.0 us | **3.1x** |
| 1024x1024 | 1   | 79.9 us | 212 us  | **2.7x** |

### Argmax

| Shape     | Dim | Ember   | NdArray | Speedup  |
| --------- | --- | ------- | ------- | -------- |
| 1K        | -   | 3.3 us  | 4.4 us  | **1.3x** |
| 256x256   | 1   | 212 us  | 247 us  | **1.2x** |
| 1024x1024 | 1   | 3.44 ms | 4.10 ms | **1.2x** |
